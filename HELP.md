...
* The original package name 'com.parent.market.oms.order-management-system' is invalid and this project uses 'com.parent.market.oms.ordermanagementsystem' instead.
